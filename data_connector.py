...
def fetch_live_project_data():
    ...
    In a real-world scenario, this is where you would connect to their actual databases.
    """
    
    # --- This is our SIMULATED live project database ---
    # It's just a simple list of projects, which makes it very safe and error-free.
    live_projects = [
